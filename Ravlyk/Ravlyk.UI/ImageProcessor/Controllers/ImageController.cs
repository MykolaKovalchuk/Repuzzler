...
namespace Ravlyk.UI.ImageProcessor
{
	public abstract class ImageController : IImageProvider, INotifyPropertyChanged
	{
		...
		public void RestoreImageSettings(IndexedImage image)
		{
			RestoreImageSettingsCore(image);
		}
		protected virtual void RestoreImageSettingsCore(IndexedImage image) { }

		public void SaveImageSettings(IndexedImage image)
		{
			SaveImageSettingsCore(image);
		}
		protected virtual void SaveImageSettingsCore(IndexedImage image) { }
		...
		IndexedImage IImageProvider.Image => Manipulator.SourceImage;
