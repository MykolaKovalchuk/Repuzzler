					...
					Parallel.For(area.Top, area.BottomExclusive,
						frameY =>
						{
								...
								frameX++, visualIndex++)
							{
								...
								{
									visualPixels[visualIndex] = originalVisualImagePixels[visualIndex].HalfToneLow();
								}
								else if (CropKind == ImageCropper.CropKind.None || IsZoomedPixelInsideCropRect(frameX, frameY))
								{
									visualPixels[visualIndex] = originalVisualImagePixels[visualIndex];
								}
								else
								{
									visualPixels[visualIndex] = originalVisualImagePixels[visualIndex].ThreeQuarterToneHigh();
								}
							}
						});
				}
