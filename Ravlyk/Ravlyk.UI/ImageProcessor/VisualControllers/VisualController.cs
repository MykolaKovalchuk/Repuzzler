...
namespace Ravlyk.UI.ImageProcessor
{
	public abstract class VisualController
	{
		...
		public IndexedImage SourceImage => ImageProvider.Image;

		public IndexedImage VisualImage
		{
			get
			{
				if (visualImage == null)
		...
		IndexedImage visualImage;

		protected virtual IndexedImage CreateVisualImage()
		{
